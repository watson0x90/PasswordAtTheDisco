...
def generate_risk_vector(password_analysis, shared_with, da_domains, controlled_object_count,
    ...
    Returns:
        str: Risk vector string in format "C:X/L:Y/D:Z/SM:W/CM:V/EX:U/DA:T/CO:S/S:R/DR:Q/HIBP:P"
    """
    ...
    if hibp_breach_count == 0:
        vector.append("HIBP:N")  # Not breached
    elif hibp_breach_count < 10:
        vector.append("HIBP:L")  # Low (1-9 breaches)
    elif hibp_breach_count < 100:
        vector.append("HIBP:M")  # Medium (10-99 breaches)
    elif hibp_breach_count < 1000:
        vector.append("HIBP:H")  # High (100-999 breaches)
    elif hibp_breach_count < 10000:
        vector.append("HIBP:VH")  # Very High (1K-9.9K breaches)
    elif hibp_breach_count < 100000:
        vector.append("HIBP:E")  # Extreme (10K-99.9K breaches)
    else:
        vector.append("HIBP:C")  # Critical (100K+ breaches)
...
def explain_risk_vector(vector_string):
    ...
    # HIBP Breach Exposure
    hibp = components.get('HIBP', 'N')
    if hibp == 'C':
        explanations.append("CRITICAL: Password found in 100,000+ breaches")
    elif hibp == 'E':
        explanations.append("Extremely common breach (10,000-99,999 occurrences)")
    elif hibp == 'VH':
        explanations.append("Very high breach exposure (1,000-9,999 occurrences)")
    elif hibp == 'H':
        explanations.append("High breach exposure (100-999 occurrences)")
    elif hibp == 'M':
        explanations.append("Moderate breach exposure (10-99 occurrences)")
    elif hibp == 'L':
        explanations.append("Low breach exposure (1-9 occurrences)")
