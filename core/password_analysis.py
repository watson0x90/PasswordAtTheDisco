...
def analyze_password(password, forbidden_words, keyboard_patterns, common_passwords, dictionary_words, compare_passwords=None, policy=None):
    """
    ...
    meets_policy_result, policy_violations = check_policy(password, custom_policy=policy)
